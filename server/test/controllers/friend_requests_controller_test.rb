...
class FriendRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend_request" do
    assert_difference('FriendRequest.count') do
      post friend_requests_url, params: { friend_request: { friend_id: @friend_request.friend_id, user_id: @friend_request.user_id } }, as: :json
    end
  ...
  test "should update friend_request" do
    patch friend_request_url(@friend_request), params: { friend_request: { friend_id: @friend_request.friend_id, user_id: @friend_request.user_id } }, as: :json
    assert_response 200
  end
